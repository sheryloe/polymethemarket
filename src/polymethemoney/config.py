...
class Settings(BaseSettings):
    ...
    strategy_slot_second_utc: int = Field(default=2, alias="STRATEGY_SLOT_SECOND_UTC")
    strategy_reconcile_normal_seconds: int = Field(default=30, alias="STRATEGY_RECONCILE_NORMAL_SECONDS")
    strategy_reconcile_near_expiry_seconds: int = Field(default=5, alias="STRATEGY_RECONCILE_NEAR_EXPIRY_SECONDS")
    strategy_reconcile_idle_seconds: int = Field(default=5, alias="STRATEGY_RECONCILE_IDLE_SECONDS")
    expiry_close_poll_seconds: int = Field(default=5, alias="EXPIRY_CLOSE_POLL_SECONDS")
    outcome_resolution_timeout_seconds: int = Field(default=180, alias="OUTCOME_RESOLUTION_TIMEOUT_SECONDS")
    funded_starting_capital_usd: float = Field(default=10000.0, alias="FUNDED_STARTING_CAPITAL_USD")
    shadow_starting_capital_usd: float = Field(default=10000.0, alias="SHADOW_STARTING_CAPITAL_USD")
    funded_position_usd: float = Field(default=500.0, alias="FUNDED_POSITION_USD")
    shadow_position_usd: float = Field(default=500.0, alias="SHADOW_POSITION_USD")
    funded_max_open_positions: int = Field(default=3, alias="FUNDED_MAX_OPEN_POSITIONS")
    funded_max_open_notional_usd: float = Field(default=1500.0, alias="FUNDED_MAX_OPEN_NOTIONAL_USD")
    funded_same_market_side_max_notional_usd: float = Field(
        default=1000.0,
        alias="FUNDED_SAME_MARKET_SIDE_MAX_NOTIONAL_USD",
    )
    funded_slot_new_notional_usd: float = Field(default=500.0, alias="FUNDED_SLOT_NEW_NOTIONAL_USD")
    funded_min_prediction_gap: float = Field(default=0.03, alias="FUNDED_MIN_PREDICTION_GAP")
    funded_min_model_confidence: float = Field(default=0.55, alias="FUNDED_MIN_MODEL_CONFIDENCE")
    funded_max_spread: float = Field(default=0.02, alias="FUNDED_MAX_SPREAD")
    funded_min_tte_seconds: int = Field(default=30, alias="FUNDED_MIN_TTE_SECONDS")
    funded_max_tte_seconds: int = Field(default=240, alias="FUNDED_MAX_TTE_SECONDS")
    ...
    ab_shadow_mode_enabled: bool = Field(default=False, alias="AB_SHADOW_MODE_ENABLED")
    ab_allocate_strategy_id: str = Field(default="model_a_contrarian", alias="AB_ALLOCATE_STRATEGY_ID")
    ab_min_model_confidence: float = Field(default=0.10, alias="AB_MIN_MODEL_CONFIDENCE")
    ab_min_prediction_gap: float = Field(default=0.001, alias="AB_MIN_PREDICTION_GAP")
    ab_entry_tte_min_seconds: int = Field(default=15, alias="AB_ENTRY_TTE_MIN_SECONDS")
    ab_entry_tte_max_seconds: int = Field(default=295, alias="AB_ENTRY_TTE_MAX_SECONDS")
    ab_revert_score_min: float = Field(default=0.0, alias="AB_REVERT_SCORE_MIN")
    ab_trend_score_min: float = Field(default=0.0, alias="AB_TREND_SCORE_MIN")
    ...
    training_horizon_minutes: int = Field(default=1, alias="TRAINING_HORIZON_MINUTES")
    ...
    training_min_tte_hours: float = Field(default=0.02, alias="TRAINING_MIN_TTE_HOURS")
    ...
    model_min_rows: int = Field(default=150, alias="MODEL_MIN_ROWS")
