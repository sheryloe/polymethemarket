...
class Settings(BaseSettings):
    ...
    min_position_usd: float = Field(default=3.0, alias="MIN_POSITION_USD")
    ...
    signal_side_policy: str = Field(default="BALANCED", alias="SIGNAL_SIDE_POLICY")
    ...
    signal_min_confidence: float = Field(default=0.22, alias="SIGNAL_MIN_CONFIDENCE")
    signal_min_quality: float = Field(default=0.15, alias="SIGNAL_MIN_QUALITY")
